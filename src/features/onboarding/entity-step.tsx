  ...
  return (
    ...
    >
      <div className="flex min-h-0 flex-1 flex-col gap-5">
        <label className="flex h-12 shrink-0 items-center gap-2 border border-border bg-background px-3.5 focus-within:outline-2 focus-within:outline-offset-2 focus-within:outline-accent">
          <svg
            aria-hidden="true"
            viewBox="0 0 18 18"
            fill="none"
